...
import com.TaggingOrganization.Tag;
import java.time.LocalDateTime;
import java.util.*;
...
public class Contact {
    ...
    public String toString() {
        return String.format(
            "Contact{id=%s, name='%s', phones=%s, emails=%s, notes='%s', tags=%s, createdAt=%s}",
            id, name, phoneNumbers, emails, notes != null ? notes : "N/A", tags, createdAt
        );
    }
}
